...
package com.river.batch.examples.relational;

import com.river.batch.examples.relational.util.WebLogData;
import com.river.batch.examples.relational.util.WebLogDataGenerator;
...
public class WebLogAnalysis {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("---filterVisits---");
		filterRanks.print();
		...
		System.out.println("-------------joinDocsRanks--------------");
		filterDocs.join(filterRanks)
				.where(0).equalTo(1).print();
